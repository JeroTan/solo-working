...
description: >-
  Use when user types /utility-authentic-voice or asks for this novel workflow
  command. Rewrite a passage to remove AI cliches and enforce authentic human
  voice.
---
# /utility-authentic-voice

Treat text after `/utility-authentic-voice` as `$ARGUMENTS`.
