...
name: utility-meta
description: >-
  Use when user types /utility-meta or asks for this novel workflow command.
  Records novel metadata — title, author, genre, tags, work type, status, and
  publication dates — to meta.json. Useful for uploading to buckets, databases,
  Royal Road-style listings, or web novel platforms.
---
# /utility-meta

Treat text after `/utility-meta` as `$ARGUMENTS`.
