...
name: utility-expert
description: >-
  Use when user types /utility-expert or asks for this novel workflow command.
  Activate expert mode for deep, specialized analysis (e.g., editor, sensitivity
  reader, logic checker).
---
# /utility-expert

Treat text after `/utility-expert` as `$ARGUMENTS`.
