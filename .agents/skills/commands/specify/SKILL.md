...
name: specify
description: >-
  Use when user types /specify or asks for this novel workflow command. Step 2:
  Creates a lean story specification and initializes knowledge files for
  detailed characters, worldbuilding, locations, voices, and glossary.
---
# /specify
