...
description: >-
  Use when user types /comics-chapter-pages-prompt or asks for this novel
  workflow command. Bonus comics workflow: generates clean AI image prompt files
  for comic chapter pages from comics-plan.md.
---
# /comics-chapter-pages-prompt

Treat text after `/comics-chapter-pages-prompt` as `$ARGUMENTS`.
