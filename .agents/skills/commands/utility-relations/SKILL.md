...
description: >-
  Use when user types /utility-relations or asks for this novel workflow
  command. Manage and analyze character relationships.
---
# /utility-relations

Treat text after `/utility-relations` as `$ARGUMENTS`.
