...
description: >-
  Use when user types /utility-character-sheets-prompt or asks for this novel
  workflow command. Bonus comics utility: creates AI prompt files for character
  reference sheets used by manga, manhwa, manhua, webtoon, and comic page
  prompts.
---
# /utility-character-sheets-prompt

Treat text after `/utility-character-sheets-prompt` as `$ARGUMENTS`.
