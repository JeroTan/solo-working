...
description: >-
  Use when user types /utility-npc-sheets-prompt or asks for this novel workflow
  command. Bonus comics utility: creates AI prompt files for NPC, race, monster,
  bestiary, crowd, guard, civilian, or general archetype reference sheets used
  by comic page prompts.
---
# /utility-npc-sheets-prompt

Treat text after `/utility-npc-sheets-prompt` as `$ARGUMENTS`.
