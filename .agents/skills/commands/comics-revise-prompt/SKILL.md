...
description: >-
  Use when user types /comics-revise-prompt or asks for this novel workflow
  command. Bonus comics workflow: revises comic page or sheet prompt files based
  on user feedback or generated image results.
---
# /comics-revise-prompt

Treat text after `/comics-revise-prompt` as `$ARGUMENTS`.
