...
name: comics-task
description: >-
  Use when user types /comics-task or asks for this novel workflow command.
  Bonus comics workflow: converts comics-plan.md into a simple comic
  chapter/page checklist.
---
# /comics-task

Treat text after `/comics-task` as `$ARGUMENTS`.
