...
name: comics-planner
description: >-
  Use when user types /comics-planner or asks for this novel workflow command.
  Bonus comics workflow: adapts written novel chapters into manga, manhwa,
  manhua, or webtoon chapter/page plans.
---
# /comics-planner
